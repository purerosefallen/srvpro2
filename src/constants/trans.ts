export const TRANSLATIONS = {
  'en-US': {
    ...
    cannot_to_duelist: 'Joining duelists is not allowed in a matchup.',
    ...
    draw_due_to_error: 'Game ended in a draw due to an error.',
  ...
  'zh-CN': {
    ...
    cannot_to_duelist: '匹配模式中观战者不允许加入决斗。',
    quit_watch: '退出了观战',
    left_game: '离开了游戏',
    ...
    draw_due_to_error: '由于发生错误，本局以平局结束。',
